 ...
 * Публичная оферта относится только к Администратору/PRO, а пока платные
 * тарифы не запущены — не требуется вообще никому (см.
 * PAYMENT_DOCUMENTS_ENABLED в services/core/legal/documents.py): backend
 * отдаёт её с `required: false`, и в гейт она не попадает.
