...
import { cookiePolicyBlocks } from '~/shared/legal/cookie-policy-content'
import { LEGAL_DOCUMENT_VERSIONS } from '~/shared/legal/version'
import styles from '../legal-page.module.scss'

export const metadata: Metadata = {
	title: 'Политика использования файлов cookie — prostoprobuy.pro',
	description: 'Политика использования файлов cookie и иных технических идентификаторов на Платформе prostoprobuy.pro.',
	robots: 'index, follow',
}
