...
import { reset, setFilter, useReportRefStore } from '~widgets/report-ref'
...
export const ReportRefFilter = ({ report }: WithReportPublicID) => {
		...
		<Card radius={'lg'} padding={'lg'}>
			<Flex alignItems={'center'} flexWrap={'wrap'} gap={14}>
				<Flex gap={16} flexWrap={'wrap'} width={isMobile && '100%'}>
					<FavoriteButton
						href={links.reports.ref(report).favorites}
					/>
