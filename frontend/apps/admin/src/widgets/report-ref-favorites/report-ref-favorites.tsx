...
import { useReportRefFavoritesStore } from '~widgets/report-ref-favorites/report-ref-favorites.hooks'
...
export const ReportRefFavorites = ({ report }: WithReportPublicID) => {
	const { isMobile } = useDeviceDetect()

	const { count, list, loading } = useReportRefFavoritesStore()
