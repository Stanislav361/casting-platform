...
│   ├── reports/                 # Каст листы и шорт-листы
...
| **Администратор** | `administrator` | Управление пользователями, кастингами, каст листами |
| **Менеджер** | `manager` | Управление кастингами и актёрами, SOFT_DELETE |
| **Продюсер** | `producer` | Просмотр каст листов и шорт-листов |
...
|------|-----|------|-------------|
| **Админ** | `admin` | 1690₽/мес | Кастинги, работа с откликнувшимися |
| **Админ PRO** | `admin_pro` | 3690₽/мес | Все актёры, полнотекстовый поиск, шорт-листы |
...
### Каст листы и шорт-листы
- `reports` — каст листы (привязка к кастингу, public_id)
- `profiles_reports` — связь профиль ↔ каст лист (избранное)
...
- [x] 3.1 Тарификация — Админ (1690₽) / Админ PRO (3690₽)
